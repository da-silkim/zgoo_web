...
public interface ChgErrorCodeRepositoryCustom {
    ...
    // 에러코드 전체 조회
    Page<ChgErrorCodeListDto> findErrorCodeWithPagination(Pageable pageable);

    // 에러코드 검색 조회
    Page<ChgErrorCodeListDto> searchErrorCodeWithPagination(String manuf, String searchOp, String searchContent, Pageable pageable);
