...
public class MemberAuthHistRepositoryCusotmImpl implements MemberAuthHistRepositoryCusotm {
    ...
    @Override
    public Page<MemberAuthHistDto> findAllMemberAuthHistWithPagination(Pageable pageable) {
    ...
    public Page<MemberAuthHistDto> findMemberAuthHistWithPagination(String searchOp,
            String contentSearch, String fromDate, String toDate, Pageable pageable) {

        log.info(
                "=== >> findMemberAuthHistWithPagination with search condition: searchOp: {}, contentSearch: {}, fromDate: {}, toDate: {}",
    ...
    public void deleteAllByMemberId(Long memberId) {
        queryFactory.delete(memberAuthHist)
                .where(memberAuthHist.member.id.eq(memberId))
                .execute();
    }
    ...
    public List<MemberAuthHistDto> findMemberAuthHistList(String searchOp, String contentSearch, String fromDate,
            String toDate) {
        log.info(
                "=== >> findMemberAuthHistList with search condition: searchOp: {}, contentSearch: {}, fromDate: {}, toDate: {}",
                searchOp, contentSearch, fromDate, toDate);
