...
public class CpModelRepositoryCustomImpl implements CpModelRepositoryCustom {
    ...
    public CpModelDetailDto findCpModelDetailOne(Long modelId) {
        ...
        CpModelDetailDto modelDetailDto = queryFactory.select(Projections.fields(CpModelDetailDto.class,
            ...
            model.powerUnit.as("powerUnit"),
            model.dualYn.as("dualYn"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.inputVoltage).as("inputVoltage"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.inputFrequency).as("inputFrequency"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.inputType).as("inputType"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.inputCurr).as("inputCurr"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.inputPower).as("inputPower"),
            Expressions.stringTemplate("IF({0} IS NULL, '정보없음', {0})", modelDetail.powerFactor).as("powerFactorToString"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.outputVoltage).as("outputVoltage"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.maxOutputCurr).as("maxOutputCurr"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.ratedPower).as("ratedPower"),
            Expressions.stringTemplate("IF({0} IS NULL, '정보없음', {0})", modelDetail.peakEfficiency).as("peakEfficiencyToString"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.thdi).as("thdi"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.grdType).as("grdType"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.opAltitude).as("opAltitude"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.opTemperature).as("opTemperature"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.temperatureDerating).as("temperatureDerating"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.storageTemperatureRange).as("storageTemperatureRange"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.humidity).as("humidity"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.dimensions).as("dimensions"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.ipNIk).as("ipNIk"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.weight).as("weight"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.material).as("material"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.cableLength).as("cableLength"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.screen).as("screen"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.rfid).as("rfid"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.emergencyBtn).as("emergencyBtn"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.communicationInterface).as("communicationInterface"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.lang).as("lang"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.coolingMethod).as("coolingMethod"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.emc).as("emc"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.protection).as("protection"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.opFunc).as("opFunc"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.standard).as("standard"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.powerModule).as("powerModule"),
            Expressions.stringTemplate("IF({0} IS NULL OR {0} = '', '정보없음', {0})", modelDetail.charger).as("charger"),
            manufCdName.name.as("manufCdName"),
            cpTypeName.name.as("cpTypeName"),
            ...
            .leftJoin(manufCdName).on(model.manufCd.eq(manufCdName.commonCode))
            .leftJoin(cpTypeName).on(model.cpType.eq(cpTypeName.commonCode))
            .leftJoin(installationTypeName).on(model.installationType.eq(installationTypeName.commonCode))
            .where(model.id.eq(modelId))
            .fetchOne();
